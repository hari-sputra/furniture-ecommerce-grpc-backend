...
func (x *HelloWorldResponse) GetMeta() *common.BaseResponse {
	if x != nil {
		return x.Meta
	}
	return nil
...
const file_service_service_proto_rawDesc = "" +
	...
	"\x04meta\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04meta\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage2X\n" +
	"\x11HelloWorldService\x12C\n" +
	"\bSayHello\x12\x1a.service.HelloWorldRequest\x1a\x1b.service.HelloWorldResponseB?Z=github.com/hari-sputra/furniture-ecommerce-grpc-be/pb/serviceb\x06proto3"
...
var file_service_service_proto_depIdxs = []int32{
	2, // 0: service.HelloWorldResponse.meta:type_name -> common.BaseResponse
	0, // 1: service.HelloWorldService.SayHello:input_type -> service.HelloWorldRequest
	1, // 2: service.HelloWorldService.SayHello:output_type -> service.HelloWorldResponse
