...
import (
	...
	common "github.com/hari-sputra/furniture-ecommerce-grpc-be/pb/common"
...
func (x *RegisterResponse) GetMeta() *common.BaseResponse {
	if x != nil {
		return x.Meta
	}
	return nil
...
func (x *LogoutResponse) GetMeta() *common.BaseResponse {
	if x != nil {
		return x.Meta
	}
	return nil
...
func (x *ChangePasswordResponse) GetMeta() *common.BaseResponse {
	if x != nil {
		return x.Meta
	}
	return nil
...
type GetProfileResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Meta          *common.BaseResponse   `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	Data          *common.UserResponse   `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetProfileResponse) GetMeta() *common.BaseResponse {
	if x != nil {
		return x.Meta
	}
	return nil
...
func (x *GetProfileResponse) GetData() *common.UserResponse {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\xbaH\ar\x05\x10\x06\x18\xff\x01R\bpassword\x12?\n" +
	"\x15password_confirmation\x18\x04 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x06\x18\xff\x01R\x14passwordConfirmation\"I\n" +
	...
	"\xbaH\ar\x05\x10\x06\x18\xff\x01R\voldPassword\x12-\n" +
	"\fnew_password\x18\x02 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x06\x18\xff\x01R\vnewPassword\x12F\n" +
	"\x19new_password_confirmation\x18\x03 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x06\x18\xff\x01R\x17newPasswordConfirmation\"\x13\n" +
	"\x11GetProfileRequest\"<\n" +
	"\x10RegisterResponse\x12(\n" +
	"\x04meta\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04meta\"\\\n" +
	"\rLoginResponse\x12(\n" +
	"\x04meta\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04meta\x12!\n" +
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken\":\n" +
	"\x0eLogoutResponse\x12(\n" +
	"\x04meta\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04meta\"B\n" +
	"\x16ChangePasswordResponse\x12(\n" +
	"\x04meta\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04meta\"h\n" +
	"\x12GetProfileResponse\x12(\n" +
	"\x04meta\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04meta\x12(\n" +
	"\x04data\x18\x02 \x01(\v2\x14.common.UserResponseR\x04data2\xbd\x02\n" +
	"\vAuthService\x129\n" +
	...
	"\n" +
	"GetProfile\x12\x17.auth.GetProfileRequest\x1a\x18.auth.GetProfileResponseB<Z:github.com/hari-sputra/furniture-ecommerce-grpc-be/pb/authb\x06proto3"
...
var file_auth_auth_proto_goTypes = []any{
	...
	(*common.UserResponse)(nil),    // 11: common.UserResponse
}
var file_auth_auth_proto_depIdxs = []int32{
	10, // 0: auth.RegisterResponse.meta:type_name -> common.BaseResponse
	10, // 1: auth.LoginResponse.meta:type_name -> common.BaseResponse
	10, // 2: auth.LogoutResponse.meta:type_name -> common.BaseResponse
	10, // 3: auth.ChangePasswordResponse.meta:type_name -> common.BaseResponse
	10, // 4: auth.GetProfileResponse.meta:type_name -> common.BaseResponse
	11, // 5: auth.GetProfileResponse.data:type_name -> common.UserResponse
	...
	3,  // 9: auth.AuthService.ChangePassword:input_type -> auth.ChangePasswordRequest
	4,  // 10: auth.AuthService.GetProfile:input_type -> auth.GetProfileRequest
	5,  // 11: auth.AuthService.Register:output_type -> auth.RegisterResponse
	6,  // 12: auth.AuthService.Login:output_type -> auth.LoginResponse
	7,  // 13: auth.AuthService.Logout:output_type -> auth.LogoutResponse
